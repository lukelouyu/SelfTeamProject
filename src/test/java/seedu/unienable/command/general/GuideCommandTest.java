...
class GuideCommandTest {
    ...
    public void execute_findTopic_showsExactGuideTextWithExamples() {
        ...
        assertEquals("Find activities\n"
                ...
                + "words per occurrence; three or more words in one k/ is rejected.\n"
                + "k/ may also be repeated (e.g. k/CS2113 k/review) to add further\n"
                + "keywords - there is no limit on how many times k/ may appear. An\n"
                + "optional leading today/tomorrow/this week/next week phrase works\n"
                + "the same as in list, and cannot be combined with date/.\n"
                + "\n"
                + "Examples:\n"
                + "  find k/PL1101E\n"
                + "  find k/lecture\n"
