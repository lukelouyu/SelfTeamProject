...
public class GuideCommand extends ReadOnlyCommand {
    ...
    private static Map<String, String> buildTopics() {
        ...
        topics.put("activities", "Add, edit and delete activities\n"
                ...
                + "\n"
                + "Quick examples:\n"
                + "  add n/CG3207 lecture c/ACADEMIC date/YYYY-MM-DD type/FIXED from/09:00 to/11:00 "
                + "energy/1 sensory/1\n"
                + "  edit 1 energy/5\n"
                + "  delete 1");
        ...
        topics.put("edit", "Edit an activity\n"
                ...
                + "  edit 3 n/CG3207 tutorial date/YYYY-MM-DD topic/CG3207\n"
                + "\n"
        ...
        topics.put("order", "Choose your default activity order\n"
                ...
                + "\n"
                + "input is insertion order. time and chronological are the same ordering:\n"
                + "earliest date first, then earliest scheduled start time on that date\n"
                + "(adopted start for an adopted flexible activity), then activity ID.\n"
                + "\n"
                + "Examples:\n"
                + "  order view\n"
                + "  order set time\n"
        ...
        topics.put("recur", "Create recurring class sessions\n"
                ...
                + "\n"
                + "Example:\n"
                + "  add n/CG3207 Lecture c/ACADEMIC date/YYYY-MM-DD type/FIXED "
        ...
        topics.put("timetable", "Text timetable\n"
                ...
                + "Examples:\n"
                + "  timetable today\n"
                + "  timetable day/YYYY-MM-DD\n"
                + "  timetable day/YYYY-MM-DD detail\n"
                + "  timetable date/YYYY-MM-DD\n"
                + "  timetable week/YYYY-MM-DD compact\n"
