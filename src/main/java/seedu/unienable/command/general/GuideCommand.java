...
public class GuideCommand extends Command {
    ...
    private static Map<String, String> buildTopics() {
        ...
        topics.put("dashboard", "Dashboard: a planning-load summary\n"
                ...
                + "energy/sensory rating distribution.\n"
                + "\n"
                + "Examples:\n"
                + "  dashboard today\n"
        ...
        topics.put("timetable", "Text timetable\n"
                ...
                + "shorthand for day/ with the current/next date. Weekly views cover Monday\n"
                + "through Sunday; next week is the following Monday-Sunday week. Flexible\n"
                + "activities stay in a separate unscheduled section with their window and\n"
                + "required duration; no time is invented for them. compact omits empty days\n"
                + "for narrow terminals, while detail adds completion, category, rating,\n"
                + "topic, and note information.\n"
                + "\n"
                + "Examples:\n"
                + "  timetable today\n"
        ...
        topics.put("recommend", "Recommended timetable\n"
                ...
                + "date/YYYY-MM-DD generates a one-day preview for any date not before\n"
                + "today. recommend view re-shows the current proposal, recommend adopt\n"
